...
useEffect(() => {
  if (response?.type === "success") {
    ...
    fetch(`${process.env.EXPO_PUBLIC_KEYCLOAK_URL}/realms/${process.env.EXPO_PUBLIC_KEYCLOAK_REALM}/protocol/openid-connect/token`, {
      method: "POST",
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <View className="w-full bg-[#111111] border border-[#1f1f1f] rounded-xl p-6">
        <Pressable
          onPress={() => promptAsync()}
          disabled={!request}
